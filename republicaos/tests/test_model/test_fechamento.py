...
class TestFechamentoContas(BaseTest):
	...
	def test_fechamento_1(self):
		...
		DespesaPeriodica(dia_vencimento = 19, quantia = 50, tipo = self.td4, responsavel = self.m1, data_cadastro = date(2006, 12, 1))
		DespesaPeriodica(dia_vencimento = 15, quantia = 45, tipo = self.td1, responsavel = self.m1, data_cadastro = date(2007, 6, 1))
	...
	def test_fechamento_2(self):
		...
		DespesaPeriodica(dia_vencimento = 17, quantia = 150, tipo = self.td4, responsavel = self.m1, data_cadastro = date(2006, 12, 1))
		DespesaPeriodica(dia_vencimento = 15, quantia = 45, tipo = self.td1, responsavel = self.m1, data_cadastro = date(2007, 6, 1))
